...
The design features of the printer and the trapezoid shaft in the guides in combination with the "oak" a4988 should have shown good results. But during 3D printing, measuring with a not very precise tool, I also had a deviation of ~0.2 mm along the Y axis, which was generally successfully corrected by software.
